...
/* VKInitalizers
*	June 2025
*   This class is pretty much lifted from VKGuide, it handles converting some basic Vulkan calls
*   into simpler calls by either defaulting or abstracting them, I intend to extend this later.
*/
...
VkRenderingInfo rendering_info(VkExtent2D renderExtent, VkRenderingAttachmentInfo* colorAttachment,
    VkRenderingAttachmentInfo* depthAttachment, uint32_t colorAttachmentCount = 1);
