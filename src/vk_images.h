...
namespace vkutil 
{
	...
	void CopyImageToBuffer(VkCommandBuffer cmd, VkImage source, VkBuffer destination, VkExtent2D srcSize, int mip = 0);
	void CopyImageToBuffer(VkCommandBuffer cmd, VkImage source, VkBuffer destination, VkExtent3D srcSize, int mip = 0);
